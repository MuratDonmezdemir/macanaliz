"""Initial migration with Referee model

Revision ID: 2013bde2d671
Revises: 
Create Date: 2025-06-11 16:51:05.431365
...
def upgrade():
    ...
    with op.batch_alter_table("matches", schema=None) as batch_op:
        ...
        # Eski foreign key kısıtlamasını kaldır
        batch_op.drop_constraint("fk_matches_league_id_leagues", type_="foreignkey")

        # Yeni foreign key kısıtlamalarını ekle
        batch_op.create_foreign_key(
            "fk_matches_referee_id_referees",
            "referees",
            ["referee_id"],
            ["id"],
            ondelete="SET NULL",
        ...
        batch_op.create_foreign_key(
            "fk_matches_venue_id_stadiums", "stadiums", ["venue_id"], ["id"]
        )
        batch_op.create_foreign_key(
