...
def initialize_sample_data():
    ...
    teams_data = [
        {"name": "Galatasaray", "country": "Turkey", "league": "Super Lig", "founded": 1905, "stadium": "Türk Telekom Stadium", "attack_strength": 85, "defense_strength": 75, "home_advantage": 8, "current_form": 78},
        {"name": "Fenerbahçe", "country": "Turkey", "league": "Super Lig", "founded": 1907, "stadium": "Şükrü Saracoğlu Stadium", "attack_strength": 82, "defense_strength": 77, "home_advantage": 7, "current_form": 75},
        {"name": "Beşiktaş", "country": "Turkey", "league": "Super Lig", "founded": 1903, "stadium": "Vodafone Park", "attack_strength": 78, "defense_strength": 72, "home_advantage": 9, "current_form": 70},
        {"name": "Trabzonspor", "country": "Turkey", "league": "Super Lig", "founded": 1967, "stadium": "Medical Park Stadium", "attack_strength": 75, "defense_strength": 74, "home_advantage": 10, "current_form": 72},
        {"name": "Başakşehir", "country": "Turkey", "league": "Super Lig", "founded": 1990, "stadium": "Başakşehir Fatih Terim Stadium", "attack_strength": 70, "defense_strength": 75, "home_advantage": 5, "current_form": 68},
        {"name": "Konyaspor", "country": "Turkey", "league": "Super Lig", "founded": 1922, "stadium": "Konya Metropolitan Stadium", "attack_strength": 65, "defense_strength": 70, "home_advantage": 6, "current_form": 65},
        {"name": "Antalyaspor", "country": "Turkey", "league": "Super Lig", "founded": 1966, "stadium": "Antalya Stadium", "attack_strength": 68, "defense_strength": 68, "home_advantage": 4, "current_form": 62},
        {"name": "Kayserispor", "country": "Turkey", "league": "Super Lig", "founded": 1966, "stadium": "Kadir Has Stadium", "attack_strength": 62, "defense_strength": 65, "home_advantage": 5, "current_form": 60},
        {"name": "Sivasspor", "country": "Turkey", "league": "Super Lig", "founded": 1967, "stadium": "Yeni 4 Eylül Stadium", "attack_strength": 63, "defense_strength": 72, "home_advantage": 7, "current_form": 64},
        {"name": "Alanyaspor", "country": "Turkey", "league": "Super Lig", "founded": 1948, "stadium": "Bahçeşehir Okulları Stadium", "attack_strength": 69, "defense_strength": 66, "home_advantage": 4, "current_form": 66}
    ]
    ...
    for team in teams:
        for i, position in enumerate(positions):
            player = Player(
                ...
                goals=random.randint(0, 15) if position in ["ST", "CAM", "LW", "RW"] else random.randint(0, 5),
            ...
            if player.is_injured:
                injury = Injury(
                    player_id=player.id,
                    injury_type=random.choice(["Muscle strain", "Ankle sprain", "Knee injury", "Hamstring"]),
                    severity=random.randint(20, 80),
                    start_date=datetime.now() - timedelta(days=random.randint(1, 30)),
                    expected_return_date=datetime.now() + timedelta(days=random.randint(5, 45)),
                    is_active=True
                )
    ...
    for team in teams:
        ...
        ).filter(Match.is_played == True).all()
...
def get_team_recent_form(team_id, limit=5):
    ...
    ).filter(Match.is_played == True).order_by(Match.match_date.desc()).limit(limit).all()
