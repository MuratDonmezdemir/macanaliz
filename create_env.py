...
def create_env_file(
    ...
    try:
        ...
        print("   Please keep your SECRET_KEY secure and do not commit it to version control!")
    except IOError as e:
...
def main() -> None:
    ...
    parser.add_argument('--force', action='store_true', help='Overwrite existing .env without confirmation')
